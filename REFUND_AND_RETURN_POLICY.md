...
**Your legal rights still apply.** A final-sale label, return deadline, or requirement to get approval does not take away a remedy the law requires for a defect, missing delivery, or other problem. This includes any cancellation or refund rights that apply to international service customers.

## 1. How Returns Work

Return options depend on what you bought. A return simply because you changed your mind needs our approval, unless your written agreement or the law says otherwise. Problems with an item, project cancellations, and warranty claims have their own sections below.

**The default return-request window and Limited Hardware Warranty period are both 14 calendar days after delivery.** Return eligibility and warranty coverage are different, as explained below. Any longer rights required by law still apply.

**Standard hardware** is hardware we regularly stock and do not make to order or customize for a customer. Hardware built for an order, even to an existing design, and hardware designed or modified to your requirements are not standard hardware. We identify made-to-order or custom status in the listing or quote before payment.

Deadlines use **America/Chicago time** and end at **11:59 p.m.** Calendar days include weekends and holidays, with the day after delivery counted as day 1. Business days are Monday through Friday, excluding observed US federal holidays, counted from the first business day after the event. A request successfully sent to our listed email address or Discord account on time counts even if we reply later. The full [deadline rules](TERMS_OF_SERVICE.md#how-we-count-deadlines) explain message timestamps and return send-by dates; legally required rules take priority.

## 2. Standard Hardware Returns

If you changed your mind about standard hardware that isn't custom or altered, please ask for a return within **14 calendar days after delivery**. We consider requests individually; approval is not guaranteed. The item must be unused, complete, and in a condition we can resell.

Please contact us before sending anything back. If we approve the return, we'll give you the address, a date to send it by, packing instructions, and an explanation of any costs deducted from your refund.

Where the law allows, deductions may include the restocking fee below, original shipping costs, payment fees we cannot recover and have told you about, or documented loss in value from damage or missing parts. We won't charge twice for the same loss or deduct more than the amount otherwise due to you.

## 3. What Usually Cannot Be Returned

Unless we agree otherwise in writing, these purchases cannot be returned just because you changed your mind:

- Made-to-order, custom-built, or custom-modified hardware, including OpenShock-related assemblies made to your specifications.
- Items built, flashed, configured, engraved, or otherwise altered specifically for you.
- Delivered software, firmware, downloads, code, scripts, or configuration files.
- Completed consulting, coding, debugging, integration, repair, or other labor.
- Opened, installed, used, or customer-damaged items, and items clearly designated clearance or final sale before purchase.

These limits do not remove a remedy we owe for a defect, incorrect work, an unfulfilled order, a written warranty, or applicable law. If you've already sent an item without approval, please contact us so we can work out the next step; sending it does not automatically qualify it for a refund.

## 4. Cancellations, Services, and Custom Work

If you need to cancel, please let us know as soon as you can. We may not be able to stop an order already in progress, but any cancellation rights required by law still apply.

For custom work and services, you pay for work actually completed before cancellation and agreed costs we have committed to and cannot recover. Any project-stage payment schedule or cancellation terms we both accepted apply where the law allows. Starting work does not, by itself, make your entire unused balance non-refundable.

We'll explain how we calculated the amount due and refund any extra you've already paid. We won't count the same work or expense twice. If we fail to do the agreed work, you still keep any remedy you're entitled to.

Customer-caused delays are handled under Section 7 of our [Terms of Service](TERMS_OF_SERVICE.md#delays-caused-by-the-customer). A delay attributable to you does not by itself entitle you to a delay penalty or discount. This does not remove any cancellation or refund right required by law.
...
If an item arrives damaged, faulty, incomplete, or significantly different from your order, please get in touch as soon as you can. Report a fault within the **14-calendar-day warranty period after delivery**, unless your order specifies a different period before purchase. Any longer warranty or legal rights still apply, including rights concerning defects discovered later.
...
We may ask you to try reasonable, safe troubleshooting steps or send the item for inspection so we can understand what went wrong. We will give you an expected assessment time when arranging the return, explain any delay, and resolve covered claims within a reasonable time or any shorter period required by law.

### Limited Hardware Warranty - Exchanges When the Fault Is Ours

NamelessNanashi provides this limited warranty for standard hardware purchased from us, as defined in Section 1. **The default coverage period is 14 calendar days after delivery**, unless a different period is stated in writing for your order before purchase. Contact us within that period with your order number or other reasonable proof of purchase and a description of the fault. You do not need to complete troubleshooting or ship the device within those 14 days if you reported the fault on time. A timely claim stays open until it is resolved; our assessment or shipping time does not cancel it.

A replacement carries the remaining coverage period of the original device unless we agree otherwise in writing or the law requires longer coverage. Replacing a device does not close a timely claim if the replacement fails to resolve the reported problem. Any longer rights required by law still apply.
...
**Made-to-order, custom-built, or custom-modified hardware is excluded from this exchange offer unless we expressly state otherwise in writing for your order.** This exclusion does not remove any remedy required by an applicable warranty or law.

Please contact us by email or on Discord before sending the device back. We'll arrange the return and, unless we agree otherwise, inspect the device before sending a replacement. **The replacement may be new or refurbished.** Refurbished replacements are tested to confirm they work and meet the agreed specifications. We'll identify the replacement's condition before arranging the exchange or authorizing any destruction. The replacement will be the same model and meet the agreed specifications; a different model or substitute requires your agreement.
...
### If Inspection Finds No Covered Fault

If we cannot reproduce the problem or find that it is outside this warranty, we'll explain our findings and any supporting test results. You can share more information for us to consider. A claim is not rejected simply because an intermittent problem did not appear on the first test.

If no covered fault is established, we'll discuss returning your device or, if available, a paid repair. You pay the shipping to have your device returned unless an agreement or law requires otherwise. We will not start a paid repair or charge an inspection fee unless we disclosed the scope and price and you agreed in writing beforehand. There is no inspection fee for a confirmed covered fault. Sending a device for assessment alone does not authorize paid work, destruction, or disposal.
...
**Before authorizing destruction, we will confirm and reserve an available replacement.** Our written approval will identify your order and device, the replacement model and specifications, whether it is new or refurbished, any agreed substitute, the replacement shipping cost and payment arrangements, and the expected dispatch date after video verification and any agreed shipping payment. If we cannot secure a suitable replacement, we will not authorize destruction; we'll discuss the normal return process or another available remedy instead.
...
If we later cannot supply the promised replacement after you followed our approved destruction instructions, we'll offer an alternative you accept or refund the device price and applicable taxes, plus any shipping refund required by law. We will not require you to return hardware we authorized you to destroy. This addresses our failure to complete an approved exchange; it does not make destruction an option for requesting a refund.
...
Approved refunds go to the original payment method where available. If that method cannot receive the refund, we will agree with you on another lawful method; we will not substitute store credit without your agreement.

For voluntary returns, we aim to inspect the item and issue an approved refund within **10 business days after receiving it**. For service cancellations, we aim to determine the balance and issue any refund within **10 business days after confirming cancellation**. If review takes longer, we will explain the delay and provide an updated estimate.

If the law requires a faster refund, that deadline takes priority. We won't delay a required refund for an unshipped order while waiting for a return or inspection. Your bank or payment provider may take extra time to show the funds. Please contact us if a refund hasn't arrived after the processing period we give you.

## 10. Payment Disputes

Please contact us about a billing or order problem so we can try to resolve it. Doing so is not required before exercising a chargeback or other payment-dispute right, and does not extend your provider's deadline.

We may provide relevant order records, delivery evidence, communications, or project records to the payment provider when responding to a dispute, consistent with our [Privacy Policy](PRIVACY_POLICY.md). We will coordinate any direct refund with the dispute process to avoid duplicate credits or charges.
...
**We do not accept routine customer communication by postal mail.** Please use email or Discord for support, warranty claims, returns, and exchanges. This does not restrict legally required notices or communication methods.
...
**Contact us by email or Discord for return authorization and the correct destination before shipping a product.** The legal correspondence address is not automatically the return destination.
